    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="{{ route('admin.dashboard.doctors') }}"><i class="fa fa-user-md"></i> <span>Doctors</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="{{ route('admin.dashboard.sections') }}"><i class="fa fa-hospital-o"></i> <span>Departments</span></a>
                </li>
                <li class="submenu">
